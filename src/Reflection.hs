...
--     Nothing -> do
--       i <- m
--       modify $ \rc -> rc { rcf = M.insert t i $ rcf rc }
--       return i
-- withP :: Provenance -> M3 Node -> M3 Node
-- withP t m = do
--   mp <- gets rcp
--   case M.lookup t mp of
--     Just i -> return i
--     Nothing -> do
--       i <- m
--       modify $ \rc -> rc { rcp = M.insert t i $ rcp rc }
--       return i
-- withR :: RankedRule -> M3 Node -> M3 Node
-- withR t m = do
--   mp <- gets rcr
--   case M.lookup t mp of
--     Just i -> return i
--     Nothing -> do
--       i <- m
--       modify $ \rc -> rc { rcr = M.insert t i $ rcr rc }
--       return i
-- withT :: Tuple -> M3 Node -> M3 Node
-- withT t m = do
--   mp <- gets rct
--   case M.lookup t mp of
--     Just i -> return i
--     Nothing -> do
--       i <- m
--       modify $ \rc -> rc { rct = M.insert t i $ rct rc }
--       return i
